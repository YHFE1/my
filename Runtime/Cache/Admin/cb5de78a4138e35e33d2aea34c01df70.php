...
<div id="page-wrapper">
    <form method="post" action="<?php echo U('Product/update');?>">
        <div class="form-group">
            <label for="post-title">产品名称</label>
            <input type="text" name="name" class="form-control" id="post-title" value="<?php echo ($product["name"]); ?>" >
        </div>
		<div class="form-group">
		...
		<div class="form-group">
            ...
            <input type="text" name="price" class="form-control" id="post-title" value="<?php echo ($product["price"]); ?>" >
        </div>
        <div class="form-group">
            <label for="post-cate">计量单位</label>
             <input type="text" name="type" class="form-control" id="post-title" value="<?php echo ($product["type"]); ?>" >
        </div>
		<div class="form-group">
            <label for="post-title">型号规格</label>
            <input type="text" name="title" class="form-control" id="post-title" value="<?php echo ($product["title"]); ?>">
        </div>
        <div class="form-group">
            <label for="post-content">详细说明</label>
            <textarea name="remarks" class="form-control" id="post-title" placeholder="<?php echo ($product["remarks"]); ?>"></textarea>
        </div>
