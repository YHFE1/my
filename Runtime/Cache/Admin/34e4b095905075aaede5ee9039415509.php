...
<div id="page-wrapper">
	...
	<div class="row">
		<div class="col-md-6" style="width:25%">
			<a href="<?php echo U('Product/add');?>" class="btn btn-success">新增</a>
		</div>
		<div class="col-md-6" style="width:25%">						
			<form id="upload" action="<?php echo U('Product/importExcel');?>" method="post" enctype="multipart/form-data">				
					<label class="btn btn-success" style="float:left;" for="file">上传文件:</label>
					<input style="width:150px;float:left;" type="file" name="file" id="file">
					<input style="width:100px;" type="submit" name="submit" value="上传" />						
			</form>
		</div>	
		<div class="col-md-6" style="width:25%">			
			<a href="<?php echo U('Product/expUser');?>" class="btn btn-success">批量导出</a>
		</div>		
		<div class="col-md-6" style="width:25%">
	...
	<table class="table table-hover table-striped">
		...
		<tbody>
			<?php if(is_array($model)): foreach($model as $key=>$v): ?><tr>
					...
					<td>
					<?php if ($v.status==0) { ?>					
					   <img src="/Test/wms/Application/Admin/View//Public/static/images/ok.gif">
					<?php  } else { ?>
					   <img src="/Test/wms/Application/Admin/View//Public/static/images/locked.gif">
					<?php
 } ?>
					</td>
					<td><a href="<?php echo U('Product/update?id='); echo ($v["id"]); ?>">编辑</a></td>					
